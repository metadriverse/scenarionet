...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_path", required=True,
                        help="Dataset path, a directory containing summary.pkl and mapping.pkl")
    parser.add_argument("--result_save_dir",
                        required=True,
                        help="Where to save the error file")
    parser.add_argument("--overwrite", action="store_true", help="If an error file already exists in result_save_dir, "
    ...
    verify_loading_into_metadrive(args.dataset_path,
