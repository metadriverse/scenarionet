...
python ../../scripts/generate_from_error_file.py --file ../tmp/test_combine_dataset/error_scenarios_for_combine_dataset.json --overwrite --dataset_path ../tmp/verify_fail --broken